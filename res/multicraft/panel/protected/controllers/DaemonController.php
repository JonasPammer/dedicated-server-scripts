...
class DaemonController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $settings['maxChatLines'] =
            array('label'=>Yii::t('admin', 'Number of lines to store in chat window'), 'unit'=>'', 'default'=>160);
        $settings['maxLogLines'] =
            array('label'=>Yii::t('admin', 'Number of lines to store in log/console window'), 'unit'=>'', 'default'=>360);
        $settings['keepBackupCount'] =
            array('label'=>Yii::t('admin', 'Number of backups to keep'), 'unit'=>'', 'default'=>6);
        $settings['serversPerPage'] =
            array('label'=>Yii::t('admin', 'Number of servers per page'), 'unit'=>'', 'default'=>10);
        $settings['defaultServerName'] =
            array('label'=>Yii::t('admin', 'Default server name'), 'unit'=>'', 'default'=>'Multicraft Server');
        ...
        $settings['defaultServerMemory'] =
            array('label'=>Yii::t('admin', 'Default amount of memory'), 'unit'=>Yii::t('admin', 'MB'), 'default'=>2048);
        ...
        $settings['defaultServerPort'] =
            array('label'=>Yii::t('admin', 'Base server port to use on new IPs'), 'unit'=>'', 'default'=>25570);
        ...
        $settings['defaultServerStartMemory'] =
            array('label'=>Yii::t('admin', 'Default amount of startup memory'), 'unit'=>Yii::t('admin', 'MB'), 'default'=>512, 'adv'=>true);
